...
#define SCL  D6 //SGP30的SCL引脚定义
#define SDA  D7  //SGP30的SDA引脚定义

#define SCL_1 digitalWrite(D6, HIGH)
#define SCL_0 digitalWrite(D6, LOW)
#define SDA_1 digitalWrite(D7, HIGH)
#define SDA_0 digitalWrite(D7, LOW)
